    ...
    <div class="footer-widget mt-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="social-icons color-hover">
                <ul>
                <li class="social-facebook"><a href="#" class="text-dark"><i class="fa fa-facebook"></i></a></li>
                <li class="social-linkedin"><a href="#" class="text-dark"><i class="fa fa-linkedin"></i></a></li>
                <li class="social-instagram"><a href="#" class="text-dark"><i class="fa fa-instagram"></i></a></li>
            ...
            <p class="text-white">© 2022  - Saiyonee All Right Reserved </p>
            </div>
        </div>
        </div>
    </div>
