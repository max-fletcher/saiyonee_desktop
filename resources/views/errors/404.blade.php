    ...
    <section class="page-section-ptb text-center clearfix error-page position-relative">
        <div class="container">
            <div class="row justify-content-start">
                ...
                <a class="button btn-lg btn-theme full-rounded animated right-icn mt-4"><span>Go to Home page<i class="glyph-icon flaticon-hearts" aria-hidden="true"></i></span></a> </div>
            </div>
        </div>
    </section>
@endsection
